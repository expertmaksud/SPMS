...
namespace ESLab.SPMS.Migrations.SeedData
{
    public class DefaultTenantRoleAndUserBuilder
    {
        ...
        public DefaultTenantRoleAndUserBuilder(SPMSDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateAdditionalRoles()
        {
            var tier1Role = _context.Roles.FirstOrDefault(r => r.TenantId == null && r.Name == "Tier1");
            if (tier1Role == null)
            {
                tier1Role = _context.Roles.Add(new Role { Name = "Tier1", DisplayName = "Tier1" });
                _context.Roles.Add(new Role { Name = "Tier2", DisplayName = "Tier2" });
                _context.Roles.Add(new Role { Name = "Tier2", DisplayName = "Tier2" });
                _context.SaveChanges();
            }
        }
