...
namespace ESLab.SPMS.Tests.Sessions
{
    public abstract class SPMSTestBase : AbpIntegratedTestBase
    {
        protected SPMSTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<SPMSApplicationModule>();
            modules.Add<SPMSDataModule>();
        }

        public void UsingDbContext(Action<SPMSDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<SPMSDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<SPMSDbContext, T> func)
        {
            T result;
